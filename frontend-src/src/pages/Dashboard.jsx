...
const recentActivity = [
  {
    text: (
      <>
        <strong>Emma Wilson</strong> marked present
      </>
    ),
    time: "2 min ago",
    color: "green",
  },
  {
    text: (
      <>
        <strong>James Brown</strong> marked absent
      </>
    ),
    time: "5 min ago",
    color: "red",
  },
  {
    text: (
      <>
        <strong>Sophia Lee</strong> marked late
      </>
    ),
    time: "12 min ago",
    color: "yellow",
  },
  {
    text: (
      <>
        <strong>Michael Chen</strong> marked present
      </>
    ),
    time: "18 min ago",
    color: "green",
  },
  {
    text: (
      <>
        <strong>Olivia Davis</strong> marked present
      </>
    ),
    time: "25 min ago",
    color: "green",
  },
  {
    text: (
      <>
        <strong>Liam Taylor</strong> marked absent
      </>
    ),
    time: "1 hour ago",
    color: "red",
        ...
        {stats.map((stat, i) => (
          <div key={i} className="stat-card">
            <div
              ...
              dangerouslySetInnerHTML={{ __html: iconSvgs[stat.icon] }}
            />
